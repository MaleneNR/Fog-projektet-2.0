...
public class Svg {
    ...
    private static final String SVG_LINE_TEMPLATE = "<line x1=\"%d\" y1=\"%d\" x2=\"%f\" y2=\"%d\"\n" +
            "              style=\"%s\"/>";
    ...
    public void addLine(int x1, int y1, double x2, int y2, String style){
        svg.append(String.format(SVG_LINE_TEMPLATE, x1, y1, x2, y2, style));
    }

    public void addArrow(int x1, int y1, double x2, int y2){
    ...
    public void addSvg(String innerSvg){
